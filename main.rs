...
type ElmName = compact_str::CompactString;
...
fn parse_same_line_while_at_least_one_as_elm_name_node(
    ...
    Some(ElmSyntaxNode {
        ...
        value: ElmName::from(&state.source[start_offset_utf8..state.offset_utf8]),
    })
}
